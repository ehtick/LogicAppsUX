...
## Summary
- 74 nodes · 91 edges · 8 communities
...
9. `CoPilotChatbotProps` - 1 edges
10. `ChatbotUIProps` - 1 edges
...
## Knowledge Gaps
- **44 isolated node(s):** `CoPilotChatbotProps`, `ChatbotUIProps`, `useChatbotDarkStyles`, `actual`, `props` (+39 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `mockUseIntl()` connect `Community 2` to `Community 0`, `Community 1`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `AssistantChat()` connect `Community 4` to `Community 0`, `Community 3`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `CopilotPanelHeader()` connect `Community 4` to `Community 2`, `Community 3`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **What connects `CoPilotChatbotProps`, `ChatbotUIProps`, `useChatbotDarkStyles` to the rest of the system?**
