...
Cohesion: 0.05
Nodes (23): useIsAgentSubGraph(), AzureResourceSelection(), useMcpServersQuery(), getConnectionMetadata(), CreateConnectionWrapper(), useEnableNestedAgentLoops(), useSupportedChannels(), useIsAgenticWorkflow() (+15 more)
...
Cohesion: 0.09
Nodes (10): EditOperationPanel(), useEditSnapshot(), useAllConnectionErrors(), useNodesTokenDependencies(), useOperationDynamicInputsError(), useOperationInputParameters(), useOperationsInputParameters(), useParameterValidationErrors() (+2 more)
...
Cohesion: 0.11
Nodes (8): ConnectorBrowse(), CustomControls(), useClampPan(), useIsA2AWorkflow(), useIsAgenticWorkflowOnly(), useShowMinimap(), Minimap(), useAllConnectors()
...
Cohesion: 0.14
Nodes (13): useSuppressDefaultNodeSelectFunctionality(), NodeDetailsPanel(), useIconUri(), useOperationErrorInfo(), useIsPanelCollapsed(), useOperationAlternateSelectedNode(), useOperationPanelAlternateNodeActiveTabId(), useOperationPanelSelectedNodeActiveTabId() (+5 more)
...
- **Why does `render()` connect `Community 620` to `Community 513`, `Community 481`, `Community 647`, `Community 521`, `Community 653`, `Community 590`, `Community 654`, `Community 655`, `Community 623`, `Community 507`, `Community 601`, `Community 635`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `renderComponent()` connect `Community 623` to `Community 620`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `renderWithProviders()` connect `Community 481` to `Community 620`?**
